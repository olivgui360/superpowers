...
**Personal skills live in agent-specific directories (`~/.claude/skills` for Claude Code, `~/.copilot/skills` for GitHub Copilot, `~/.codex/skills` for Codex)** 
...
**Purpose:** The agent reads descriptions to decide which skills to load for a given task. Make it answer: "Should I read this skill right now?"
...
**The trap:** Descriptions that summarize workflow create a shortcut agents will take. The skill body becomes documentation the agent skips.
